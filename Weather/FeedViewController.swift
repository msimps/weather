...
class FeedViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    let postList: [Post] = []/*
        Post(user: User(name: "Bill Gates", userPhoto: [Photo(image: "Bill Gates/1", likes: 50)]), created_at: "8 minutes ago", text: "GShard: Scaling Giant Models with Conditional Computation and Automatic Sharding https://arxiv.org/abs/2006.16668", image: "", likesCount: 23, commentsCount: 29, repostsCount: 4, viewsCount: 243),
        
        Post(user: User(name: "Elon Musk", userPhoto: [Photo(image: "Elon Musk/1", likes: 63)]), created_at: "3 hours ago", text: "Going to the Mars! Who with me?", image: "Elon Musk/1", likesCount: 42, commentsCount: 29, repostsCount: 4, viewsCount: 243),
        
        Post(user: User(name: "Sergey Brin", userPhoto: [Photo(image: "Sergey Brin/1", likes: 63)]), created_at: "5 hours ago", text: "", image: "Sergey Brin/1", likesCount: 42, commentsCount: 29, repostsCount: 4, viewsCount: 243),
        Post(user: User(name: "Sergey Brin", userPhoto: [Photo(image: "Sergey Brin/1", likes: 63)]), created_at: "5 hours ago", text: "Mmmm, strawberry!!", image: "Sergey Brin/2", likesCount: 22, commentsCount: 29, repostsCount: 4, viewsCount: 243),
